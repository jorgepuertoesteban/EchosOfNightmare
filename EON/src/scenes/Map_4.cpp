...
void Map_4::CreateMagnet(Vec2 pos) {
...
void Map_4::CreateMechanism(Vec2 pos, Vec2 size, int rotation, int door) {
...
void Map_4::CreateDoor(Vec2 pos, Vec2 size, int rotation, int door) {
...
PVector<Mechanism>* Map_4::GetMechanisms() {
	return &m_mechanisms;
}
...
PVector<Door>* Map_4::GetDoors() {
	return &m_doors;
}
PVector<Rock>* Map_4::GetRocks() {
	return &m_rocks;
}
PVector<Magnet>* Map_4::GetMagnets() {
	return &m_magnets;
}
bool Map_4::End() {
	return m_end;
