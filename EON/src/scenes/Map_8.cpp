...
void Map_8::CreateMagnet(Vec2 pos) {
...
void Map_8::CreateMechanism(Vec2 pos, Vec2 size, int rotation, int door) {
...
void Map_8::CreateDoor(Vec2 pos, Vec2 size, int rotation, int door) {
...
PVector<Mechanism>* Map_8::GetMechanisms() {
	return &m_mechanisms;
}
...
PVector<Door>* Map_8::GetDoors() {
	return &m_doors;
}
PVector<Rock>* Map_8::GetRocks() {
	return &m_rocks;
}
PVector<Magnet>* Map_8::GetMagnets() {
	return &m_magnets;
}
bool Map_8::End() {
	return m_end;
